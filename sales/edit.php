...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateStmt->bind_param("sssiissii", $name, $category, $type, $quantity, $price, $total, $payment_mode, $product_id, $id);
    ...
    <form action="edit.php?id=<?php echo $id; ?>" method="POST">
        ...
        <div class="row">
            ...
            <div class="mb-3 col">
                ...
                <input type="number" id="quantity" name="quantity" class="form-control" value="<?php echo htmlspecialchars($sale['quantity']); ?>" required/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="mb-3 col">
                ...
                <input type="number" id="price" name="price" class="form-control" value="<?php echo htmlspecialchars($sale['price']); ?>" required/>
            </div>
            <div class="mb-3 col">
